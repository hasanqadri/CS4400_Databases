...
router.post('/update', [
    ...
    function (req, res) {
        let our_datapoint = new datapoint(res.results[0].location_name, res.results[0].date_time, res.results[0].data_value, res.results[0].data_type, res.results[0].accepted);
